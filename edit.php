...
if(isset($_POST['submit'])){
  ...
  $sql = "UPDATE `idcrud` SET `first_name`='$first_name',`last_name`='$last_name',`email`='$email',`gender`='$gender' WHERE id = $id ";
...
<body>
  ...
  $sql = "SELECT * FROM `idcrud` WHERE id = $id LIMIT 1";
  $result = mysqli_query($conn, $sql);
  ...
  <div class="container d-flex  justify-content-center">
    <form action="" method="post" style="width: 50vw; min-width:300px;" >
      <div class="row mb-3">
        ...
        <!-- different syntax for updating radio -->
